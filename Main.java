...
class Login extends Template implements ActionListener, Runnable
{
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource()==SUBMIT)
        {
            ...
            if(value1.equals("AdminUser")&& value2.equals("AdminUser"))
            {
            ...
            else
            {
                ...
                if(attemp == 0)
                {
                    JOptionPane.showMessageDialog(this,"Number of attemps finished","File Packer Unpacker",JOptionPane.ERROR_MESSAGE);
                    this.dispose();
                    System.exit(0);
                }
